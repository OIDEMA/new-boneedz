<nav id="navbar" class="navbar order-last order-lg-0">
    <ul>
        ...
        <li><a class="nav-link" href="<?php echo home_url('/qna/') ?>">FAQ</a></li>
        ...
        <li><a class="nav-link" href="<?php echo home_url('/shop/') ?>">オンラインショップ</a></li>
        <li><a class="nav-link" href="<?php echo home_url('/blogs/') ?>">ブログ</a></li>
